 ...
 * @author jonUser
 */
public class LockerViewer extends javax.swing.JFrame {

    /**
     * Creates new form LockerViewer
     */
    public LockerViewer() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel3.setText("                               Locker Viewer");

        jLabel4.setFont(new java.awt.Font("Times New Roman", 1, 36)); // NOI18N
        jLabel4.setText("Details for locker are:");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LockerViewer.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new LockerViewer().setVisible(true);
            }
        });
    }
