...
public class AddStudent extends javax.swing.JFrame {
  ...
  private DBTESTER dbconn = new DBTESTER();
   private String nextId = "L00"+(Integer.valueOf(dbconn.getNextId())+1);
    ...
    private void addButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addButtonActionPerformed
        ...
        if(firstname.getText().isEmpty() || lastname.getText().isEmpty() || addresss.getText().isEmpty())
            JOptionPane.showMessageDialog(null, "Check your values for Firstname, lastname and address. It should not be empty.");
	...
	String myQuery = "INSERT INTO StudentTester VALUES ('"+lno.getText()+"','"+ firstname.getText()+"','"+ lastname.getText()+"','"+ addresss.getText()+"','" +course.getSelectedItem()+"','"+ year.getSelectedItem()+"','"+paymentstatus.getSelectedItem()+"','"+ quota.getSelectedItem()+"',null)";
