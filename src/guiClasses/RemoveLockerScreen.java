 ...
 * @author jonUser
 */
public class RemoveLockerScreen extends javax.swing.JFrame {

    /**
     * Creates new form RemoveLockerScreen
     */
    public RemoveLockerScreen() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel3.setText("       Locker Removed");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RemoveLockerScreen.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new RemoveLockerScreen().setVisible(true);
            }
        });
    }
